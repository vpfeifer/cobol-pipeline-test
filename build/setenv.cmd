...
set "PROJECT=c:\projects\cobol-pipeline-test"
set "MAINSRC=%PROJECT%\src"
set "TESTSRC=%PROJECT%\tests"
set "MAINCPY=%MAINSRC%\copy"
set "TESTCPY=%TESTSRC%\unit-tests"
set "MAINRSC=%PROJECT%\src\resources"
set "TESTRSC=%PROJECT%\tests\resources"
